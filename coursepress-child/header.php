 ...
 *
 *RJW Added:
 *1) thankyou-fb-pixel.php call at bottom of <head>
 *2) traffic-fb-pixel.php call at bottom of <head>
 *3) google-analytics.php call at top of <body>
  *4) thank-you-styles.php call in <head> if the page is the thank you page. (commented out by default)
 */
?><!DOCTYPE html>
<html <?php language_attributes(); ?>>
    <head>
        ...
        <?php 
        /*Check if function exists. Will return false if WooCommerce is not active*/
        if (function_exists('is_order_received_page')){
        	if ( is_order_received_page()){ 	
			/*Includes Facebook tracking script on Thank You Page only*/
			include_once("thankyou-fb-pixel.php");
			/*Calls in specific styles for checkout page. Commented out by default.*/
			//include_once("thank-you-styles.php");
	 		}
	 	}?>

	 	 <?php /*Includes Facebook tracking script on all pages*/
		include_once("traffic-fb-pixel.php");?>
    </head>
